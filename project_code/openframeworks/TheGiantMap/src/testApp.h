...
class testApp : public ofBaseApp{
    ...
    //GiantStep
    vector<GiantStepLog> giantStepLogs;
    ...
    // GUI Explosion Param
    ofParameter<bool> paramIsExplosionEnabled;
    ofParameter<int>  paramExplosionSparkParticleNum;
    ofParameter<int>  paramExplosionSmokeParticleNum;
    // GUI show sensor map
    ofParameter<bool> paramIsShowSensorTile;
